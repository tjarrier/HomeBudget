...
- [x] **Step 2 : Écrire le test de formatage (il échoue)**
...
- [x] **Step 5 : Page d'accueil provisoire et layout**
...
- [x] **Step 1 : Installer Better Auth**

```bash
pnpm --filter @homebudget/db add better-auth
```

- [x] **Step 2 : Générer le schéma Drizzle de Better Auth**
...
- [x] **Step 3 : Rendre le schéma visible de Drizzle et des consommateurs**
...
- [x] **Step 4 : Générer et appliquer la migration**
...
- [x] **Step 5 : Vérifier que les invariants existants ont survécu**
...
- [x] **Step 1 : Installer Better Auth côté web**

```bash
pnpm --filter @homebudget/web add better-auth
```

- [x] **Step 2 : Écrire le test (il échoue)**
...
- [x] **Step 4 : Implémenter l'allowlist**
...
- [x] **Step 5 : Implémenter la config Better Auth**
...
- [x] **Step 7 : Jalon humain — le client OAuth Google**
...
- [x] **Step 3 : Layout du groupe protégé**
...
- [x] **Step 1 : Écrire le test unitaire du mapper (il échoue)**
...
- [x] **Step 3 : Implémenter le mapper**
...
- [x] **Step 5 : Implémenter la façade de lecture**
...
- [x] **Step 6 : Réutiliser le mapper dans le seed (DRY)**
...
- [x] **Step 8 : Écrire le test d'intégration de la lecture**
...
- [x] **Step 1 : Installer les primitives shadcn/ui**
...
- [x] **Step 1 : Écrire le test du parseur de montant (il échoue)**
...
- [x] **Step 3 : Implémenter dans le domaine**
...
- [x] **Step 5 : Écrire le test d'intégration de l'écriture (il échoue)**
...
- [x] **Step 7 : Implémenter la façade d'écriture**
...
- [x] **Step 1 : La liste (Server Component)**
...
- [x] **Step 2 : Le formulaire guidé (Client Component)**
...
- [x] **Step 1 : Écrire le test (il échoue)**
...
- [x] **Step 3 : Le formulaire, pré-rempli depuis la version courante**
...
- [x] **Step 1 : La garde d'architecture (elle doit passer d'emblée)**
...
- [x] **Step 4 : La configuration Playwright**
...
- [x] **Step 6 : Lancer les tests E2E en local**
...
- [x] **Step 8 : Mettre à jour `CLAUDE.md`**
...
- [x] **Step 9 : Vérification finale, sur un dépôt propre**
